            ...
            <table>
              <div class="row">
                ...
                <div class="col-lg-2 mb-3">
                  ...
                  <input type="date" class="form-control form-control-user2" id="inputFasilitas"
                    name="txt_tanggal_selesai" />
                </div>
                <div class="col-lg-3 mb-3 d-flex align-items-end pb-2">
                  <button type="submit" class="btn text-white colorPrimary roundedBtn" name="simpan"
            ...
            <table>
              <div class="row">
                <div class="col-lg-2 mb-3" hidden>
                  <label for="inputJenis" class="form-label">Tanggal Mulai</label>
                  <input type="date" class="form-control form-control-user2" id="inputJenis" name="txt_tanggal_mulaih"
                ...
                <div class="col-lg-3 mb-3">
                  <button type="submit" class="btn text-white colorPrimary roundedBtn" name="simpan" style="width: 80px;">Harian</button>
                </div>
              </div>
              <td>
              </td>
          ...
          <form action="cetakLaporanMingguan.php" method="POST">
            <table>
              <div class="row">
                <div class="col-lg-2 mb-3" hidden>
                  <label for="inputJenis" class="form-label">Tanggal Mulai</label>
                  <input type="date" class="form-control form-control-user2" id="inputJenis" name="txt_tanggal_mulaim"
          ...
          <form action="cetakLaporanBulanan.php" method="POST">
            <table>
              <div class="row">
                <div class="col-lg-2 mb-3" hidden>
                  <label for="inputJenis" class="form-label">Tanggal Mulai</label>
                  <input type="date" class="form-control form-control-user2" id="inputJenis" name="txt_tanggal_mulaib"
          ...
          <form action="cetakLaporanTahunan.php" method="POST">
            <table>
              <div class="row">
                <div class="col-lg-2 mb-3" hidden>
                  <label for="inputJenis" class="form-label">Tanggal Mulai</label>
                  <input type="date" class="form-control form-control-user2" id="inputJenis" name="txt_tanggal_mulait"
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="lihatPembayaran.php?id_pembayaran=<?php echo $id_pemesanan ?>" class="btn btn-info"><i
                          class="fas fa-file-invoice-dollar"></i></a><br>
