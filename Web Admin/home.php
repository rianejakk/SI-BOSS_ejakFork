      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="tables_kegiatan.php">Kegiatan</a>
            ...
            <div class="col-lg-6 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Praktikum Workshop SI berbasis Web</h6>
                </div>
                <div class="card-body">
                  <div class="text-center">
                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="img/undraw_posting_photo.svg" alt="">
                  </div>
                  <p>Pada praktikum ini membuat sebuah laman website untuk admin dan operator guna memanajemen data yang ada pada database. Implementasi yang dapat digunakan adalah 
                    sebuah sistem login yang memiliki 2 otoritas yaitu <b>Admin</b> dan <b>Operator</b>.
                  </a>
                </div>
              </div>
            </div>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Workshop SI berbasis Web</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
