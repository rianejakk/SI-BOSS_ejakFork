<?php
    ...
    if(!$obj->detailAdministrator($_GET['txt_id_user_admin'])) die ("Error: Id tidak ada");
    ...
    if($obj->updateAdministrator($nama, $jenis_kelamin, $alamat, $no_hp, $foto, $id_level, $id_terminal, $email, $password, $obj->id_user_admin)){
