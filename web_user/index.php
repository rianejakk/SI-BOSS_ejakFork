          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-caption">
              ...
              <p class="animate__animated animate__fadeInUp px-5" style="animation-delay: 0.5s">
                Salah satu harta karun keindahan alam di Jawa Timur adalah Pantai Papuma Jember. Sebagai tempat wisata, Pantai Papuma sangat cocok untuk dikunjungi karena menyimpan banyak pesona dan keindahan alam. Terdapat juga beberapa objek dan fasilitas yang unik di pantai satu ini.
              </p>
            </div>
          </div>
        ...
        <div class="container py-1">
          <div class="row myrow1 py-sm-3 animate__animated animate__fadeInLeft">
            <div class="col-sm-6 pe-sm-5 text-center text-sm-start">
              ...
              <p class="my-4 pe-xl-8">Anda kesulitan mencari tiket bis ? Kami bisa membantu Anda dalam mencari tiket bis sesuai tujuan yang Anda inginkan. Yuk cek disini !</p>
              <a href="#"
                ><button class="btn colorPrimary text-white d-none d-sm-inline-block">Cek <span>Tiket Anda Sekarang !</span></button>
              </a>
            </div>
            <div class="col-sm-6">
        ...
        <div class="container py-1">
          <div class="row myrow1 py-sm-3 animate__animated animate__fadeInRight">
            <div class="col-sm-6 ps-sm-5 text-center text-sm-start order-sm-2">
              ...
              <p class="my-4 pe-xl-8">Si-Boss memiliki rute perjalanan yang mengantarkan Anda ke kota tujuan dengan opsi pemberhentian pada terminal yang diinginkan.</p>
            </div>
        ...
        <div class="container py-1">
          <div class="row myrow1 mb-4">
            <div class="col-12 text-center">
              ...
              <i class=""></i>
              <p class="px-3 myPagrph"><b>SI-BOSS</b> dikembangkan oleh mahasiswa prodi Teknik Informatika kampus Politeknik Negeri Jember. Sistem Informasi ini digunakan untuk pemesanan tiket bus antar kota baik dengan mudah baik luar provinsi maupun di dalam provinsi. Memesan tiket bus di SI-Boss dapat dilakukan dimanapun dan kapanpun kita berada.</p>
            </div>
          </div>
        </div>
      </section>
