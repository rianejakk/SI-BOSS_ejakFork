                  ...
                  <div class="panel-banner2 py-5 bg-white myRounded shadow mod" style="height: 480px">
                    ...
                    <form class="custom-validation" action="login.php" method="POST">
                      <div class="mb-3">
                        ...
                        <input type="email" class="form-control form-control-user2" id="exampleInputEmail" name="txt_email" required data-parsley-required-message="Email tidak boleh kosong !!!" placeholder="Ex: budiman@siboss.com" />
                      </div>
                      <div class="mb-2">
                        ...
                        <input
                          ...
                          maxlength="16"
                          data-parsley-length-message="Harus disiisi 8 sampai 16 karakter !!!"
                          aria-label="password"
                        />
                      </div>
